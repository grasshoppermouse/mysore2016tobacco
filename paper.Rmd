...
caption(tmp5) <- "Summary statistics for sample demographics and key outcome variables for original sample and those remaining at followup (d: Cohen's d for mean difference; p: p-value for mean difference)."
tmp5
